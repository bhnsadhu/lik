    ...
    <div className="setup-page">
      <div className="setup-inner">
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '16px 18px 8px' }}>
          <span onClick={() => navigate('/setup/basics')} style={{ fontSize: '18px', color: 'rgba(255,255,255,0.35)', cursor: 'pointer', fontFamily: "'Outfit', sans-serif", fontWeight: 300, padding: '8px', margin: '-8px' }}>←</span>
