        ...
        return (
          <React.Fragment key={step}>
            <div
              ...
              style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '3px', cursor: 'pointer', padding: '8px' }}
            >
              <div style={{
            ...
            {i < steps.length - 1 && (
              <div style={{ flex: 1, height: '1px', background: done ? 'rgba(61,220,255,0.3)' : 'rgba(255,255,255,0.06)', marginTop: '3px', marginLeft: '4px', marginRight: '4px' }} />
            )}
          </React.Fragment>
        );
      })}
